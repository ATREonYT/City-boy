...
- **US COPPA amendments.**
  ...
  - Implication for SubOne: the competition includes students aged 9 to 19. The search extract did not say which of these two pages it quoted: [Autodesk and F1 in Schools press release](https://adsknews.autodesk.com/en/pressrelease/f1-in-schools-and-autodesk-partner-to-deliver-design-software-to-students-worldwide/); [Digital Engineering 24/7](https://www.digitalengineering247.com/article/racing-to-build-high-performance-mini-cars/cam). The age gate at 13 must therefore be neutral, not nudging children to lie. Any future teacher-managed accounts for under-13s would bring in COPPA (in the US) and parental-consent rules (in the EU).
